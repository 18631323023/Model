...
public class BodyKeyPointUtil {
    ...
    public static void main(String[] args) throws IOException {
        RequestModel model = new RequestModel();
        model.setGwUrl("https://aiapi.jd.com/jdai/face_detect_attr");
        model.setAppkey("0e39d25ff7f437889e331ca2039a919a");
        model.setSecretKey("a16006bca35147ea8b68d71dba83904d");
        Map<String, Object> queryMap = new HashMap();
        queryMap.put("imageBase64",ImageUtil.getImgStr("C:\\Users\\86186\\Desktop\\新建文件夹\\1574301590873.jpg"));
        queryMap.put("return_landmark",2);
        model.setQueryParams(queryMap);
        WxApiCall call = new WxApiCall();
        call.setModel(model);
