...
public class ImageUtil {
    ...
    public static String cut(String srcpath,int x,int y,int height,int width)throws IOException {
        String subpath= SystemConfig.getString("pictureurl")+new Date().getTime()+"_"+new Random().nextInt(1000) +"partition"+".jpg";
    ...
    public static String getPCpicture(MultipartFile file, double ratio)throws IOException {
        ...
        String imgurl = System.getProperty("pictureurl")+new Date().getTime()+"_"+new Random().nextInt(1000)+".jpg";
        ...
        System.out.println("源图宽"+widthR);
        System.out.println("源图高"+heightR);
        int widthW =0;
        int heightW =0;
        ...
        System.out.println("压缩后图片宽："+widthW);
        System.out.println("压缩后图片高："+heightW);
    ...
    public static String reduceImg(String imgsrc) {
         String imgdist = SystemConfig.getString("pictureurl")+new Date().getTime()+"_"+new Random().nextInt(1000) +".jpg";
        try {
    ...
    public static void main(String[] args) throws Exception {
        String filePath = "D:\\微信3-4.jpg";
        String newFilePath ="D:\\3333.png";
