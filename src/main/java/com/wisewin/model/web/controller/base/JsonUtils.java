...
import com.wisewin.model.util.DateJsonValueProcessor;
import com.wisewin.model.util.DateUtils;
import com.wisewin.model.util.MyDateMorpher;
import com.wisewin.model.util.StringUtils;
import net.sf.json.*;
...
public class JsonUtils {
	...
	public static Object getObject4JsonObject(JSONObject jsonObject, Class pojoCalss, String format) {
		...
		if(format == null){
			format = com.wisewin.model.util.JsonUtils.LONG_DATE_PATTERN;
		}
